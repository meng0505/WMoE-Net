...
class LoadImagesAndVideos:
    ...
    def _resolve_sar_path(rgb_path: str) -> str:
        ...
        """Resolve paired SAR path, preferring imagesSAR and keeping imagesIR fallback."""
        ...
        p_sar = rgb_path.replace("images", "imagesSAR")

        if Path(p_sar).exists():

            return p_sar

        return rgb_path.replace("images", "imagesIR")
    ...
    def __next__(self):
        ...
        while len(imgs) < self.bs:
            ...
            sar_path = self._resolve_sar_path(path)
            ...
            if self.video_flag[self.count]:
                ...
                if path.split(".")[-1].lower() == "heic":
                    ...
                    im0 = (
                        ...
                        cv2.imread(path) if self.hyp.ch < 4 else cv2.merge((cv2.imread(sar_path), cv2.imread(path)))
